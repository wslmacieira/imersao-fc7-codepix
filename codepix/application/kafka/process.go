...
import (
	...
	"github.com/wslmacieira/imersao/codepix-go/application/factory"
	appmodel "github.com/wslmacieira/imersao/codepix-go/application/model"
...
func (k *KafkaProcessor) processMessage(msg *ckafka.Message) {
	...
	transactionConfirmatioTopic := "transaction_confirmatio"
